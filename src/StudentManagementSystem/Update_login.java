...
public class Update_login extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        int i;
        for (i = 0; i < n; i++) {
            if (a[i].equals("name") == true && field[i].getText().toString().equals("") == true) {
                mark = i;
